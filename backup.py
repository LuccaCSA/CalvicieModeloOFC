...
#Codigo funcional com graficos estabilizzados overlifiting contido
...
with open("modelo_calvos_cabeludos_ajustado.pkl", "wb") as model_file:
    pickle.dump(mlp, model_file)

with open("scaler_ajustado.pkl", "wb") as scaler_file:
